<?php
  ...
  define('PROOT', '/sweet-estate/'); // set this to '/' for a live server.
  ...
  define('SITE_TITLE', 'Sweet-Estate'); // This will be used if no site title is set
  define('MENU_BRAND', 'SWEET-ESTATE'); //This is the Brand text in the menu
